  ...
  return (
    <div>
      ...
      peer-focus:text-[#00754a] peer-focus:text-[13px] ${
        email
          ? "top-[-50%] translate-y-[40%] bg-[#f0f7f5] text-[#00754a] text-[13px]"
          : "top-[50%] translate-y-[-50%]"
      } md:text-[1.2rem] px-[.4rem] font-semibold tracking-wide text-[#000000de] z-[2] transition-all`}
              htmlFor="username"
            >
      ...
      <div className="text-center mt-10 md:my-20 px-4 md:max-w-[380px] mx-auto">
        ...
        <button className="border border-[#00754a] text-[#00754a] font-bold rounded-full px-[16px] py-[7px]">Join now</button>
      </div>
    </div>
  );
}
