...
function MainAdmin() {
  ...
  return (
    <div>
      ...
      <div className="px-4 border rounded-xl md:py-8 md:mx-auto md:max-w-[500px] md:px-6 shadow-[0_2px_4px_#00000012,0_4px_5px_#0000000f,0_1px_10px_#0000001a]">
        <form action="">
          ...
          <div className="relative border border-[#999999] rounded-[8px] focus-within:shadow-[0_0_0_2px_#00754a] focus-within:bg-[hsl(160_32%_87%_/33%)] px-[16px] py-[12px]">
            ...
            />
            <label
              className="absolute left-[16px] top-[50%]  translate-y-[-50%] text-[1rem] md:text-[1.2rem] px-[.4rem]
                font-semibold tracking-wide text-[#000000de] z-[2] transition-all  
                peer-placeholder-shown:translate-y-[50%] peer-focus:translate-y-[40%]
                peer-focus:top-[-50%] peer-focus:bg-[#f0f7f5] peer-focus:text-[#00754a] peer-focus:text-[13px]"
              htmlFor="username"
            >
              <span className="#00754a">*</span> Username or email address
            </label>
          </div>
          ...
          <div className="relative flex items-center mt-5 md:mt-10">
            ...
            <input
              ...
              className="border-0 opacity-0 overflow-hidden absolute left-1 top-2"
              type="checkbox"
              name=""
              id="remember"
            />
