        ...
        <div className="custom:px-[100px] lg:mx-auto">
          ...
          >
            <p className="text-[#ffffffb3] pb-1 text-[14px] font-semibold lg:hidden">
              {selectedLocation ? selectedLocation.name : "For item availability, choose a store"}

            </p>
            <div className="text-[#ffffffb3] hidden pb-1 font-semibold lg:block">
              {selectedLocation.name ? "Pickup Store" : "For item availability"}
              <p className="text-white text-[18px] flex items-center">
              {selectedLocation ? selectedLocation.name : "Choose a store"}
              <svg
              aria-hidden="true"
