        ...
        <div className="lg:flex">
              ...
              <fieldset className="flex items-center justify-center gap-8">
         
                {
                  ...
                  productName?.sizes.map((item) =>{
                    const sizeImage = sizeImages.find((ad) => ad.name === item.sizeCode);
                  ...
                  >
                    <img
                      loading="lazy"
                      src={size === item.sizeCode ? sizeImage?.imgActive : sizeImage?.img}
                      alt={item?.sizeCode}
                    ...
                    <p className="text-[14px] md:text-[15px] ">{sizeImage?.size}</p>
                  </label>
                    )
                  })
                }
          ...
          <div className="included max-w-[450px] px-[1.6rem] lg:w-[50%] xl:w-[60%] xl:ml-[40px] mx-auto mt-[1.6rem]">
            ...
            <div className="text-center lg:text-start">
              <button className="bg-[#1e3932] py-[16px] px-[32px] rounded-[500px] text-white mt-[2rem]">
