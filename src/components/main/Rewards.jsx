                ...
                {[0, 1, 2, 3, 4].map((index) => (
                  <button
                    ...
                    className={`py-[10px] w-full transition-transform ease-in-out transform duration-700 ${
                      activeIndex === index ? "border-b-4 border-[#00754a]" : ""
                    }`}
              ...
              >
                {slides.map((slide) => (
                  <SwiperSlide key={slide.id}>
                    <div className="w-full h-[300px] bg-[#d4e9e2] flex justify-center items-center">
                      <div className="max-w-[850px] w-full px-4">
                        <div className="flex flex-col md:flex-row justify-center items-center bg-[#d4e9e2] transition duration-700">
          ...
          <div className="pt-[2.4rem]">
            <div className="text-center w-full">
              ...
              <p className="pt-[1rem] max-w-[680px] mx-auto font-medium text-[14px] md:text-[16px]">
                Joining Starbucks® Rewards means unlocking access to benefits
                like quick and easy ordering, tasty Rewards and—yes, free
                coffee.
              </p>
            </div>
              ...
              >
                ...
                <SwiperSlide>
                  <div className="mb-10">
                    ...
                    <p className="text-[14px] font-medium tracking-wider pb-10">
                      Every year on your birthday get a free drink or food item
                      of your choice.
                    </p>
                  </div>
                </SwiperSlide>
                <SwiperSlide>
                  <div className="mb-10">
                    ...
                    <p className="text-[14px] font-medium tracking-wider pb-10">
                      More Caffè Verona® Blend, please. We’re happy to refill
                      your hot cup while you’re in the store. Just ask.
                    </p>
                  </div>
                </SwiperSlide>
                ...
                <SwiperSlide>
                  <div className="mb-10">
                    ...
                    <p className="text-[14px] font-medium tracking-wider pb-10">
                      ...
                      location. Then tell the barista your name when you swing
                      by the pickup area to grab your order.
                    </p>
                  </div>
                </SwiperSlide>
                <SwiperSlide>
                  <div className="mb-10">
                    ...
                    <p className="text-[14px] font-medium tracking-wider pb-10">
                      Our app lets you customize your order and track an
                      estimated pickup time. Make sure to save your favorites so
                      they’re all ready for your next order.
                    </p>
                  </div>
                </SwiperSlide>
                <div className="swiper-button-next swiper-next-2" />
              ...
              >
                <SwiperSlide>
                  <div className="mb-10">
                    ...
                    <p className="text-[14px] font-medium tracking-wider pb-10">
                      Rack up the Stars with regular opportunities to get
                      rewarded for what you love.
                    </p>
                  </div>
                </SwiperSlide>
          ...
          <div className="px-0 md:px-[2rem] md:py-[2rem]">
            <div className="bg-[#d4e9e2] px-6 md:px-[2rem]">
              ...
              <div className="text-center py-[3rem]">
                <a
                  className="bg-[hsl(158_100%_23%)] px-[16px] py-[7px] min-w-[35px] min-h-[35px] text-white rounded-full font-semibold"
                  href=""
                >
